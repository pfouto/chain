...
public class DistPaxosPiggyProto extends GenericProtocol {

    public final static short PROTOCOL_ID = 400;
    public final static String PROTOCOL_NAME = "DistPiggyProto";
    ...
    private static final Logger logger = LogManager.getLogger(DistPaxosPiggyProto.class);
    ...
    public DistPaxosPiggyProto(Properties props, EventLoopGroup workerGroup) throws UnknownHostException {
    ...
    public void init(Properties props) throws HandlerRegistrationException, IOException {
        ...
        logger.info("DistinguishedPiggy: " + membership + " qs " + QUORUM_SIZE);
    }
    ...
    private void uponAcceptMsg(AcceptDecMsg msg, Host from, short sourceProto, int channel) {
        ...
        for (DecisionMsg decisionMsg : msg.decisionMsgs) {
            uponDecisionMsg(decisionMsg, from, sourceProto, channel);
        }
        ...
        if (from.equals(self))
            ...
            sendOrEnqueue(acceptedMsg, from);
        lastLeaderOp = System.currentTimeMillis();
    }
