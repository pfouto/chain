...
public class ChainPaxosMixedFront extends FrontendProto {
    ...
    public final static String PROTOCOL_NAME_BASE = "ChainFrontMixed_";
    ...
    public ChainPaxosMixedFront(Properties props, EventLoopGroup workerGroup, short protoIndex) throws IOException {
